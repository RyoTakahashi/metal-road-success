...
const BOND_TOPICS: Topic[] = [
  ...
  {
    line: L("「なあ、あたしたちの音楽ってさ、ちゃんと『あたしたちの』音になってると思う？ 最近それが気になって」", "\"Hey — do you think our music actually sounds like *ours* yet? It's been on my mind lately.\""),
    replies: [
      { label: L("「なってる。誰にも真似できない音だよ、あたしたちは」", "\"It does. Nobody else can make our sound.\""), love: 10, bond: 8, mood: "happy", react: L("「……そっか。あんたにそう言われると、自信持てるよ」", "\"...Yeah. Hearing you say that gives me confidence.\"") },
      { label: L("「まだ道の途中だ。だから面白いんだろ」", "\"Still on the way there. That's what makes it fun.\""), love: 4, bond: 9, stam: -3, mood: "fired", react: L("「はは、違いない。もっと磨いてやるか」", "\"Ha, can't argue. Let's sharpen it more, then.\"") },
      { label: L("「さあ。深く考えたことないな」", "\"Dunno. Never really thought about it.\""), love: -3, bond: 4, mood: "sad", react: L("「……そっか。あたしだけが気にしてたのかもね」", "\"...I see. Maybe I'm the only one who cares.\"") },
    ],
  },
  {
  ...
  {
    line: L("「……あのさ。ちゃんと言ったことなかったけど、あんたがいてくれて助かってる。いつもありがとう」", "\"...So. I never really said it, but I'm grateful you're here. Thanks, always.\""),
    replies: [
      { label: L("「こっちのセリフだよ。あたしたち、お互い様だろ」", "\"That's my line. We carry each other — that's the deal.\""), love: 11, bond: 9, mood: "happy", react: L("「……っ、そういうこと言うのずるいって。うん、お互い様だ」", "\"...Ngh, that's a low blow. Yeah — we carry each other.\"") },
      { label: L("「照れるからやめろ。……気持ちは受け取った」", "\"Cut it out, you're embarrassing me. ...But I hear you.\""), love: 5, bond: 6, mood: "normal", react: L("「あはは、顔赤いよ。まあ、伝わったならいいや」", "\"Haha, your face is red. Well, as long as it got through.\"") },
      { label: L("「急に何。気持ち悪いって」", "\"What's with the sudden sappiness. Creepy.\""), love: -4, bond: 3, mood: "sad", react: L("「……せっかく素直になったのに。もう言わない」", "\"...I finally opened up and this is what I get. Never again.\"") },
    ],
  },
  {
    line: L("「曲が全然降りてこないんだ……才能ないのかもって、たまに思う」", "\"Nothing's coming to me songwriting-wise... sometimes I think I've just got no talent.\""),
    replies: [
      { label: L("「才能とか関係ない。降りてくるまで、あたしが横で付き合う」", "\"Talent's got nothing to do with it. I'll sit with you until it comes.\""), love: 10, bond: 8, stam: -2, mood: "happy", react: L("「……ありがとう。一人じゃないって思えると、書ける気がするよ」", "\"...Thank you. Knowing I'm not alone, I feel like I can write.\"") },
      { label: L("「今日は離れよう。焦ると余計出ないぞ」", "\"Step away for today. Forcing it just makes it worse.\""), love: 5, bond: 6, stam: 5, mood: "normal", react: L("「……そうだね。ちょっと頭、冷やしてくる」", "\"...You're right. I'll go cool my head a bit.\"") },
      { label: L("「才能がないなら努力で埋めろよ」", "\"No talent? Then make up for it with effort.\""), love: -3, bond: 3, mood: "sad", react: L("「……そんなこと、自分が一番分かってるよ」", "\"...I know that better than anyone, thanks.\"") },
    ],
  },
  {
    line: L("「機材のローンも家賃も、正直きつくてさ……このまま続けて、大丈夫なのかな」", "\"The gear loan, the rent — it's honestly rough... can we even keep this up?\""),
    replies: [
      { label: L("「金のことはあたしがなんとかする。お前は音に集中しろ」", "\"I'll handle the money. You focus on the sound.\""), love: 10, bond: 7, mood: "happy", react: L("「……頼もしいな。じゃあ、その分いい音出すよ」", "\"...Reliable. Then I'll pay you back in good sound.\"") },
      { label: L("「一緒に節約プラン練ろう。数字、見える化すれば怖くない」", "\"Let's build a budget together. Numbers aren't scary once you can see them.\""), love: 5, bond: 8, stam: -2, mood: "fired", react: L("「……ん。ちゃんと向き合えば、なんとかなる気がしてきた」", "\"...Mm. Facing it head-on, I feel like we can manage.\"") },
      { label: L("「金の話ばっかりだな、辛気くさい」", "\"Always money, money — what a drag.\""), love: -4, bond: 3, mood: "sad", react: L("「……現実だよ。分かってくれないんだ、そっか」", "\"...It's reality. You don't get it. I see.\"") },
    ],
  },
  {
    line: L("「昨日はちょっと言い過ぎた。……悪かったよ。まだ怒ってる？」", "\"I went too far yesterday. ...Sorry. Are you still mad?\""),
    replies: [
      { label: L("「怒ってない。本気でぶつかれる仲間だって証拠だろ」", "\"Not mad. It just means we care enough to clash for real.\""), love: 10, bond: 9, mood: "happy", react: L("「……そう言ってもらえると、救われる。ありがとな」", "\"...Hearing that is a relief. Thank you.\"") },
      { label: L("「あたしも言い過ぎた。おあいこにしよう」", "\"I went too far too. Let's call it even.\""), love: 5, bond: 7, mood: "normal", react: L("「ふ、おあいこか。……うん、それでいこう」", "\"Heh, even, huh. ...Yeah, let's go with that.\"") },
      { label: L("「まだ怒ってるに決まってんだろ」", "\"Of course I'm still mad.\""), love: -3, bond: 2, mood: "sad", react: L("「……だよな。ごめん。もう少し、時間おくよ」", "\"...Fair. Sorry. I'll give it some more time.\"") },
    ],
  },
];
...
const PRACTICE_TOPICS_BY_MEMBER: Record<string, Topic[]> = {
  ...
  KEN: [ // NAO — stoic shredder bird
    ...
    {
      line: L("「……このスケール、指がもつれる。俺はまだ弾けてない。付き合ってくれるか」", "\"...My fingers tangle on this scale. I haven't got it yet. Will you stay with me?\""),
      replies: [
        { label: L("「もちろん。お前が弾けるまで、あたしも帰らない」", "\"Of course. I'm not leaving till you've got it either.\""), love: 6, stat: { p: "T", d: 1 }, stam: -3, mood: "happy", react: L("「……そうか。なら、朝までやるぞ。覚悟しとけ」", "\"...I see. Then we're at it till dawn. Brace yourself.\"") },
        { label: L("「テンポ落として体に入れよう。急がば回れだ」", "\"Slow the tempo and drill it into your hands. Slow is fast.\""), love: 4, stat: { p: "S", d: 1 }, stam: -2, mood: "fired", react: L("「……なるほど。理にかなってる。やってみる」", "\"...Makes sense. That's logical. I'll try it.\"") },
        { label: L("「センスでカバーすればいいだろ」", "\"Just cover it with raw feel.\""), love: -3, mood: "sad", react: L("「……センスで誤魔化す音を、俺は許せないんだ」", "\"...A sound papered over with feel — I can't accept that.\"") },
      ],
    },
  ],
  MIO: [ // MAKO — cool, quiet frog
    ...
    {
      line: L("「……このフレーズ、目立ちすぎ、かな。わたし、前に出るの、まだこわくて……」", "\"...Is this phrase too showy? I'm still scared to step forward...\""),
      replies: [
        { label: L("「出ていい。お前の音、もっと聴きたい人がいる。あたしとか」", "\"Step out. Someone wants to hear more of your sound. Me, for one.\""), love: 7, stat: { p: "S", d: 1 }, mood: "happy", react: L("「……ん。……じゃあ、少しだけ、勇気出してみる」", "\"...Mm. ...Then I'll work up just a little courage.\"") },
        { label: L("「まずは小さく前に。慣れたら、もっと出よう」", "\"Start with a small step out. Once you're used to it, go further.\""), love: 4, stat: { p: "T", d: 1 }, stam: -2, mood: "fired", react: L("「……うん。それなら、わたしにも、できそう」", "\"...Yeah. Put that way, I think even I can do it.\"") },
        { label: L("「こわいなら引っ込んでれば？」", "\"If you're scared, just stay in the back?\""), love: -4, mood: "sad", react: L("「……そう、だよね。……わたし、やっぱり後ろにいる」", "\"...Right. ...I'll stay in the back after all.\"") },
      ],
    },
  ],
...
const MEMBER_EVENTS: MemberEvent[] = [
  ...
  {
    art: "KEN", // NAO — stoic perfectionist, first person 俺
    bg: "studio",
    line: L("「……今の音、コンマ数秒ズレた。俺には分かる。もう一回、頭からやらせてくれ」", "\"...That was off by a fraction of a second. I can tell. Let me take it from the top again.\""),
    replies: [
      { label: L("「その耳、信じるよ。納得いくまで付き合う」", "\"I trust that ear. I'll stay till you're satisfied.\""), love: 8, stat: { p: "T", d: 1 }, stam: -2, mood: "happy", react: L("「……助かる。お前が横にいると、詰め切れる」", "\"...Appreciated. With you beside me, I can nail it.\"") },
      { label: L("「一回休憩な。耳が疲れると精度も落ちる」", "\"Take a break first. Tired ears kill your accuracy.\""), love: 4, stam: 5, mood: "normal", react: L("「……ふっ、それも一理あるか。少しだけだぞ」", "\"...Heh, there's truth in that. Only for a moment, though.\"") },
      { label: L("「誰も気づかないって。気にしすぎ」", "\"Nobody'll notice. You're overthinking it.\""), love: -3, mood: "sad", react: L("「……俺が気づく。それじゃ意味がないんだ」", "\"...I notice. That's what makes it meaningless.\"") },
    ],
  },
  {
    art: "KEN", // NAO — stoic perfectionist, first person 俺
  ...
  {
    art: "GO", // TOMO — hyper genki drummer, first person あたし
    bg: "studio",
    line: L("「見て見て〜っ！ あたし、両手の連打これだけ速くなったの！ ドドドドドッてね！ すごくない！？」", "\"Look look~! My double-hand rolls got this fast! Like ratatatatat! Isn't that amazing!?\""),
    replies: [
      { label: L("「すごい! 見違えた! お前の努力、ちゃんと出てる」", "\"Amazing! Total transformation! Your hard work is showing.\""), love: 9, stat: { p: "T", d: 1 }, mood: "happy", react: L("「えへへ〜! やった〜! もっと速くしちゃうもんね!」", "\"Ehehe~! Yay~! I'm gonna get even faster!\"") },
      { label: L("「速いね。あとは粒を揃えると化けるぞ」", "\"Fast! Even out the hits and you'll level up.\""), love: 4, stat: { p: "P", d: 1 }, stam: -2, mood: "fired", react: L("「粒! なるほど! よーし、揃えてやる〜! もう一回!」", "\"Even hits! Got it! Alright, I'll even 'em out~! One more!\"") },
      { label: L("「うるさいだけじゃない？」", "\"Isn't that just noisy?\""), love: -4, mood: "sad", react: L("「えぇ〜っ……そんな言い方ないよぉ……ちぇっ」", "\"Whaat... that's such a mean way to put it... tch.\"") },
    ],
  },
  {
    art: "GO", // TOMO — hyper genki drummer, first person あたし
  ...
  {
    art: "MIO", // MAKO — shy, quiet worrier, first person わたし
    bg: "backstage",
    line: L("「……本番、こわい。指、震えてる……わたし、ちゃんと弾けるかな……」", "\"...I'm scared of the show. My fingers are shaking... can I even play right...?\""),
    replies: [
      { label: L("「大丈夫。あたしがすぐ横にいる。お前の音、支えるから」", "\"You'll be fine. I'm right beside you. I'll hold up your sound.\""), love: 9, stat: { p: "T", d: 1 }, mood: "happy", react: L("「……ん。……よかった。あなたがいるなら、弾ける」", "\"...Mm. ...Good. If you're here, I can play.\"") },
      { label: L("「深呼吸しよう。一緒にゆっくり、吸って、吐いて」", "\"Let's breathe. Together, slow — in, and out.\""), love: 5, stam: 4, mood: "normal", react: L("「……すぅ……はぁ……。ん、ちょっと、落ち着いた」", "\"...(inhale)... (exhale)... Mm, I calmed down a little.\"") },
      { label: L("「震えるくらいなら出るなよ」", "\"If you're shaking that much, don't go on.\""), love: -4, mood: "sad", react: L("「……そう、だよね。わたし、いない方が……」", "\"...Right. Maybe I'm better off... not there.\"") },
    ],
  },
  {
    art: "MIO", // MAKO — shy, quiet worrier, first person わたし
    bg: "studio",
    line: L("「……このベース、中古で安かったんだ。傷だらけだけど……わたし、この子の音、好き」", "\"...I got this bass cheap, secondhand. It's all scratched up... but I love this one's sound.\""),
    replies: [
      { label: L("「いい音だよ。値段じゃない、お前が鳴らすからいい音になる」", "\"It sounds great. Not the price — it sounds great because you play it.\""), love: 9, stat: { p: "S", d: 1 }, mood: "happy", react: L("「……ふふ。……そんなこと言われたの、はじめて。うれしい」", "\"...Heh. ...No one's ever said that to me. I'm happy.\"") },
      { label: L("「大事に使ってるんだな。弦だけ新しくするか」", "\"You really take care of it. Let's at least get new strings.\""), love: 4, stat: { p: "T", d: 1 }, funds: -5_000, mood: "normal", react: L("「……いいの？ ……ありがと。この子も、喜んでる」", "\"...Really? ...Thank you. This one's happy too.\"") },
      { label: L("「安物は安物の音しか出ないだろ」", "\"Cheap gear only makes cheap sound.\""), love: -3, mood: "sad", react: L("「……そっか。……わたしの耳が、おかしいのかな」", "\"...I see. ...Maybe there's something wrong with my ears.\"") },
    ],
  },
  {
    art: "RYO", // RISA — cocky flashy frontwoman, first person あたし
    bg: "venueBig",
  ...
  },
  {
    art: "RYO", // RISA — cocky flashy frontwoman, first person あたし
    bg: "backstage",
    line: L("「新曲のサビ、あたしの声で一番目立つように書き直したの。……文句、ある？」", "\"I rewrote the new chorus so my voice stands out the most. ...Got a problem with that?\""),
    replies: [
...
const PARTY_SCRIPTS: PartyScript[] = [
  {
    ...
    options: [
      ...
      { label: L("「疲れた。今日はもう解散でいい」", "\"I'm beat. Let's just call it a night.\""), love: -3, bond: 3, mood: "sad", react: L("「……あ、うん。そっか。お疲れ、気をつけて……」", "\"...Oh, yeah. I see. Good work, get home safe...\"") },
    ],
  },
  {
    ...
    options: [
      ...
      { label: L("「主役とか、そういうの興味ない」", "\"Star of the party — I'm not into that stuff.\""), love: -3, bond: 3, mood: "sad", react: L("「……えっ、ノリ悪ぅ。ちょっと、しょんぼりだよ」", "\"...Huh, what a buzzkill. Kind of a bummer.\"") },
    ],
  },
  {
    ...
    options: [
      ...
      { label: L("「別に。もう終わったことだろ」", "\"Whatever. It's over now anyway.\""), love: -3, bond: 3, mood: "sad", react: L("「……そっか。振り返るの、あたしだけか。寂しいな」", "\"...I see. Guess I'm the only one looking back. Lonely.\"") },
    ],
  },
  {
    ...
    options: [
      ...
      { label: L("「疲れた顔だよ。ほっといてくれ」", "\"It's a tired face. Just leave me be.\""), love: -3, bond: 3, mood: "sad", react: L("「……あ、ごめん。なんか、気に障ったよね」", "\"...Oh, sorry. I touched a nerve, huh.\"") },
    ],
  },
  {
    ...
    options: [
      ...
      { label: L("「MVPとか、どうでもよくない？」", "\"Does an MVP even matter?\""), love: -2, bond: 3, mood: "sad", react: L("「……えー。せっかく聞いたのに、つまんないの」", "\"...Aw. I finally asked and that's your answer? Boring.\"") },
    ],
  },
  {
    ask: L("「ライブ終わりのこの感じ、いつまでも慣れないな。……リーダーは今どんな気分？」", "\"This feeling right after a show — I never get used to it. ...How are you feeling right now, leader?\""),
    options: [
      { label: L("「最高の夜。あたしはこの瞬間のためにやってる」", "\"Best night ever. This is the moment I do it all for.\""), love: 7, bond: 8, mood: "happy", react: L("「……だよな。分かる。今日は特別だった」", "\"...Right? I get it. Tonight was special.\"") },
      { label: L("「悪くない。でもあたしたちはまだ登り始めだ」", "\"Not bad. But we're only at the start of the climb.\""), love: 4, bond: 9, stam: -2, mood: "fired", react: L("「うわ、まだ上見てる。……そういうとこ、頼れる」", "\"Whoa, still looking up. ...That's the part I lean on.\"") },
      { label: L("「別に。普通のライブだったろ」", "\"Nothing special. It was just an average show.\""), love: -3, bond: 3, mood: "sad", react: L("「……そっか。ちょっと、しんみりしちゃうな、それ」", "\"...I see. That kind of takes the wind out of me.\"") },
    ],
  },
  {
    ask: L("「次、あたしたちどこまで行けると思う？ リーダーの本音が聞きたい」", "\"How far do you think we can go next? I want your real answer, leader.\""),
    options: [
      { label: L("「もっとデカい箱で会いに行く。あたしがそこまで連れてく」", "\"We'll play a bigger room next. I'll get us there myself.\""), love: 8, bond: 8, mood: "happy", react: L("「その一言で十分だよ。ついてく」", "\"That one line is all I needed. I'm with you.\"") },
      { label: L("「今日の課題、全部潰してからだ。反省会いくぞ」", "\"After we crush tonight's weak spots. Post-mortem time.\""), love: 3, bond: 10, stam: -3, mood: "fired", react: L("「うへぇ、打ち上げで仕事するの……でも、乗った」", "\"Ugh, working at the after-party... but fine, I'm in.\"") },
      { label: L("「さあな。行けるとこまでじゃない？」", "\"Who knows. As far as we get, I guess?\""), love: -2, bond: 4, mood: "sad", react: L("「……なんか、他人事みたいだね。ちょっと寂しいや」", "\"...Sounds kind of detached. That's a little lonely.\"") },
    ],
  },
  {
    ask: L("「今日ステージ上がる前さ、リーダー、なんて声かけてくれたか覚えてる？」", "\"Before we went on tonight — do you remember what you said to us, leader?\""),
    options: [
      { label: L("「『あたしたちなら大丈夫』だろ。今もそう思ってる」", "\"'We've got this' — right? I still mean it.\""), love: 8, bond: 7, mood: "happy", react: L("「……覚えててくれたんだ。あれ、効いたよ、本当に」", "\"...You remembered. That really got to me, honestly.\"") },
      { label: L("「細かいことは忘れた。次はもっと良い言葉かける」", "\"Forgot the details. I'll find better words next time.\""), love: 4, bond: 6, mood: "normal", react: L("「あはは、正直だな。まあ、それも嬉しいけどさ」", "\"Haha, so honest. Well, that makes me happy too.\"") },
      { label: L("「覚えてない。そんな大事なことか？」", "\"Don't remember. Was it that important?\""), love: -3, bond: 3, mood: "sad", react: L("「……あたしには大事だったんだけどな。まあいいや」", "\"...It was important to me, though. Never mind.\"") },
    ],
  },
  {
    ask: L("「正直さ、今日ちょっとヘトヘトなんだよね。リーダーは平気なの？」", "\"Honestly, I'm kind of wiped tonight. Are you holding up okay, leader?\""),
    options: [
      { label: L("「無理すんな。今日はもう飲んで、あとは寝ろ」", "\"Don't push it. Drink tonight, then just sleep.\""), love: 7, bond: 6, stam: 6, mood: "happy", react: L("「……その優しさ、ずるいって。ありがと、甘えるわ」", "\"...That kindness is unfair. Thanks, I'll take you up on it.\"") },
      { label: L("「あたしも限界。でも一杯だけ付き合ってくれよ」", "\"I'm at my limit too. But stay for just one, yeah?\""), love: 5, bond: 7, stam: 3, mood: "normal", react: L("「ふふ、しょうがないな。一杯だけね」", "\"Heh, can't help you. Just the one, though.\"") },
      { label: L("「その程度で疲れんな。気が緩んでる」", "\"Tired from that little? You're getting soft.\""), love: -4, bond: 3, mood: "sad", react: L("「……そっか。頑張ったつもりだったんだけどな」", "\"...I see. I thought I gave it everything, though.\"") },
    ],
  },
  {
...
export interface Milestone {
  ...
  tip?: string; // qualitative "how to approach it" line for the intro (the
  //             numeric target still shows on the board checklist)
}
...
export function buildMilestoneIntro(state: GameState, m: Milestone): Scene[] {
  ...
  return [
    ...
    m.tip
      ? scene("studio", [lead], L(`期限は${m.deadline}ヶ月目。${m.tip}\n\n（詳しい目標は画面上部のチェックリストで確認できる）`, `Deadline: month ${m.deadline}. ${m.tip}\n\n(The exact targets are on the checklist at the top of the screen.)`), { fx: "flash" })
...
export function buildIntroSequence(state: GameState): Scene[] {
  ...
  // The backstory + member intros + stat primer are reviewable (◀ 戻る);
  // from the how-to-play tutorial onward it's forward-only.
  const reviewable = [
  ...
  // The very last intro beat kicks off the game — label it "Start".
  const lastBeat = scenes[scenes.length - 1];
  if (lastBeat && !lastBeat.choices) lastBeat.nextLabel = L("▶ スタート", "▶ Start");
  return scenes;
}
